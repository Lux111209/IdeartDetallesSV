...
export const useFetchRecoverPassword = () => {
  ...
  const handleVerifyCode = async (inputCode) => {
    ...
    try {
  const response = await fetch(`${import.meta.env.VITE_API_URL}/passwordRecovery/verifyCode`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          email: emailToUse,
  ...
  const handleNewPassword = async () => {
    ...
    try {
  const response = await fetch(`${import.meta.env.VITE_API_URL}/passwordRecovery/newPassword`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          email: emailToUse,
